...
rtmclient = slack.RTMClient(SLACK_BOT_TOKEN)
...
def handle_command(command, channel, pl, current_song):
    """
    ...
    def say_request(**payload):
        ...
        response = "Now playing: {0}".format(song_name)
...
if __name__ == "__main__":
    ...
    if slack_client.rtm_connect(with_team_state=False):
        ...
        while True:
            ...
            if command:
                current_song, this_channel = handle_command(command, channel, pl, current_song)
